...
This project will be conducted by three interns:
* Two interns for data science research & model development.
* One intern for software design & development.
...
At the end of the internship, the intern shall deliver a finalized product with source codes, and documentation:
